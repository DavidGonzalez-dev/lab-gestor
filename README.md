...
- **Formato de Firma:**
  ...
  - **Como** coordinador, **quiero** que cada usuario registrado tenga una firma (por ejemplo: _David Gonzalez_ se transforma a _D. Gonzalez_), para identificar en qué análisis intervino cada usuario.
